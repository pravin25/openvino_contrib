...
* [**OpenVino SAM6D**](./modules/3d/JiehongLin-SAM-6D): OpenVINO-based segmentation and 6D pose estimation pipeline.
...
* [**OpenVino SAM6D**](./modules/3d/JiehongLin-SAM-6D/SAM-6D): Check the [OV_README](./modules/3d/JiehongLin-SAM-6D/SAM-6D/OV_README.md) for how to run SAM6D.
